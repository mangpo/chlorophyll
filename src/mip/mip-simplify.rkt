...
(require (only-in "../../../../lib/rosette/rosette/base/core/term.rkt"
         ...
         (only-in "../../../../lib/rosette/rosette/base/core/bool.rkt"
                  @! @&& @|| @=>)
         (only-in "../../../../lib/rosette/rosette/base/core/real.rkt" 
                  @integer? @real? @= @< @<= @>= @> 
...
(define (simplify asserts)
  ...
  (pretty-display `(time ,(- t2 t1) ,(- t3 t2) ,(- t4 t3)))
  temp
  )
...
;;(ite (= 0 x$2) (+ 10 (ite* (⊢ (= 0 x$2) (ite (= 0 x$1) (+ 10 (ite* (⊢ (= 0 x$1) (ite (= 0 x$0) 10 0)) (⊢ (= 1 x$1) (ite (= 1 x$0) 10 0)) (⊢ (= 2 x$1) (ite (= 2 x$0) 10 0)) (⊢ (= 3 x$1) (ite (= 3 x$0) 10 0)))) (ite (= 0 x$0) 10 0))) (⊢ (= 1 x$2) ...) ...)) ...))
